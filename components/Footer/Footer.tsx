...
export default function Footer() {
  return (
    <footer className="max-w-4xl mx-auto px-4 py-1 mt-[6%] max500:!mt-[10%]">
      ...
      <div className="max-w-3xl mb-10">
        ...
        <p className="text-gray-600 text-base max500:text-[14px] max500:leading-6">
        ...
        <div className="flex-1 max-w-xl">
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 rounded-full border border-gray-200 focus:outline-none max500:!text-[14px] focus:ring-2 focus:ring-gray-200"
            />
          ...
          <p className="text-gray-500 text-sm mt-2 max500:!text-[12px]">
      ...
      <div className="footer-links-container">
        <div className="flex items-center max500:justify-center gap-6  overflow-x-scroll max500:text-[10px]">
          <Link href="/" className="text-gray-600 text-sm max500:text-[10px] hover:text-gray-900">
            Home
          </Link>
          <Link href="/" className="text-gray-600 text-sm max500:text-[10px] hover:text-gray-900">
            Templates
        ...
        <div className="flex items-center text-gray-500 text-sm ">
          <span className="ml-4 max500:text-[12px] max500:mt-4">© 2025 Folio Lynkr - All rights reserved.</span>
        </div>
      </div>
      <div className='flex justify-center items-center mt-8 py-0'>
