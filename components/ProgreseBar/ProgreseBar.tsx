  ...
  return (
    <div className="relative min-h-[600px] w-full md:w-72 bg-[#574EFA] rounded-lg p-8 bg-gradient-to-b from-[#574EFA] to-[#4A3FF7]">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-8">
        <div className="w-full h-32 bg-[url('https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Screenshot%202025-01-18%20at%201.09.48%E2%80%AFPM-pk0cWu57s5VXrEV44oTzlMNRXeB1L2.png')] bg-contain bg-no-repeat bg-bottom opacity-50" />
      </div>
    </div>
  );
};
