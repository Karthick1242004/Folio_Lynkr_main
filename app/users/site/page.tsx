        ...
        <div className="space-y-1">
          ...
          <div className="flex items-center justify-between pt-2 max500:flex-col max500:gap-2 max500:items-start">
            <div className="flex items-center gap-[1px]">
              <Link
                href="#"
                className="inline-flex items-center gap-2 text-sm bg-black/5 hover:bg-black/10 px-3 py-2 rounded-l-full transition-colors"
              >
              ...
              <Link
                href="#"
                className="inline-flex items-center gap-2 text-sm bg-black/5 hover:bg-black/10 px-3 py-2 rounded-r-full transition-colors"
              >
          ...
          <div>
            <Image className="rounded-[10px] overflow-hidden mt-4 pb-1" src={site.imageUrl} alt={site.title} width={1000} height={1000} />
          </div>
          <div className=" flex items-center  gap-4 border border-blue-100 bg-blue-50 p-4 rounded-[10px] max500:px-2 max500:gap-2">
            <svg
            ...
            <p className="text-sm max500:leading-4 text-blue-700 flex-1 max500:!text-[12px]">
            ...
            <button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-full text-sm whitespace-nowrap transition-colors max500:px-3 max500:py-2 max500:text-[12px]">
              Make it yours
            </button>
          </div>
        </div>
